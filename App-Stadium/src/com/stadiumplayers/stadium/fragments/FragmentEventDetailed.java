...
public class FragmentEventDetailed extends Fragment implements View.OnClickListener {
    ...
    public static FragmentEventDetailed newInstance(
            String eventHostName,
            Sport sport,
            long epochTime,
            String languifiedLocation,
            LatLng location,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String title = String.format(
                "%s's %s Game",
                args.getString(KEY_EVENT_HOST_NAME),
                sport.getName());
        ...
        getChildFragmentManager()
                .beginTransaction()
                .add(R.id.event_detailed_map_container, fragment, FragmentMapModule.class.getSimpleName())
                .commit();
